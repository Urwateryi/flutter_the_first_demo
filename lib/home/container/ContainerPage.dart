  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      ...
      body: new ListView(
        ...
        children: <Widget>[
          new Text('我不是药神：你我生而平凡',
              style: new TextStyle(color: Colors.black54, fontSize: 23.0)),
          new Row(
            children: <Widget>[
              new Image.asset('assets/images/illustration_5.jpg',
                  width: 35.0, height: 35.0, fit: BoxFit.cover),
              new Text('Sherry晨星',
                  style: new TextStyle(color: Colors.black54, fontSize: 15.0)),
              new Text('+关注',
                  style:
                      new TextStyle(color: Colors.greenAccent, fontSize: 14.0))
            ],
          ),
          new Row(
            children: <Widget>[
