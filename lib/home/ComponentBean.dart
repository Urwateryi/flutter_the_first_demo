...
List<ComponentBean> contentList = <ComponentBean>[
  ...
  ComponentBean(
      "Button", ButtonPage(), "按钮，其中写onPress和不写，样式会有差异", "assets/images/illustration_4.jpg"),
  ComponentBean("Text", TextPage(), "文本控件", "assets/images/illustration_9.jpg"),
  ComponentBean(
      "Image", ImagePage(), "图片控件", "assets/images/illustration_11.jpg"),
  ComponentBean(
      "Card", CardPage(), "卡片布局，自带阴影和一定的圆角", "assets/images/illustration_21.jpg"),
  ComponentBean(
      "Stack", StackPage(), "层叠布局，相当于Android中的FrameLayout", "assets/images/illustration_20.jpg"),
  ComponentBean(
      "Scaffold", ScaffoldPage(), "脚手架", "assets/images/illustration_5.jpg"),
  ComponentBean(
      "Appbar", AppBarPage(), "就是AppBar嘛", "assets/images/illustration_8.jpg"),
  ComponentBean(
      "Input", new InputPage(), "输入框", "assets/images/illustration_13.jpg"),
  ComponentBean(
      "Form", new FormPage(), "表单", "assets/images/illustration_13.jpg"),
  ComponentBean("Decoration", new DecorationPage(),
      "装饰器，对各个控件进行装饰，比如给文字添加下划线，给图片切圆角等等", "assets/images/illustration_27.jpg"),
  ComponentBean("FlutterLogo", new FlutterLogoPage(),
      "Flutter的Logo，可以设置大小，颜色，Logo和文字的排列", "assets/images/illustration_6.jpg"),
  ComponentBean("Placeholder", new PlaceHolderPage(),
      "占位符，一个用来占位的Widget，提示开发人员，这里需要暂时保留", "assets/images/illustration_7.jpg"),
  ComponentBean("CheckBox", null, "单选框", "assets/images/illustration_14.jpg"),
  ComponentBean("RadioGroup", null, "多选框", "assets/images/illustration_15.jpg"),
  ComponentBean("Progress", null, "进度条", "assets/images/illustration_16.jpg"),
  ...
  ComponentBean("const和new的区别", null, "const和new的区别",
      "assets/images/illustration_27.jpg"),
  ComponentBean("GridView", null, "网格布局", "assets/images/illustration_22.jpg"),
  ComponentBean(
  ...
  ComponentBean("网络请求", null, "网络请求封装", "assets/images/illustration_25.jpg"),
